...
namespace SmashBros.Model
{
    ...
    public class MoveStats
    {
        ...
        public MoveStats(int damage, int duration, int start, int end, int aniFrom, int aniTo, int aniEffectFrom, int aniEffectTo, Vector2 power, Vector2 sqFrom, Vector2 sqTo, Vector2 sqSize)
        {
            Damage = damage;
            Duration = duration;
            Start = start;
    ...
    public class RangeMove : AdjustableMove
    {
        ...
        public RangeMove(int damage, int duration, int start, int aniFrom, int aniTo, int aniEffectFrom, int aniEffectTo, Vector2 power, Vector2 sqFrom, Vector2 sqSize,
            Vector2 bulletVelocity, int aniBulletFrom, int aniBulletTo, bool gravity = false, bool heatSeaking = false, MoveStats explotion = null, bool stopAtHit = true, int stopAfter = -1, float adjustAcc = 0, int aniAdjustmodeFrom = 0, int aniAdjustmodeTo = 0)
