...
\title{TDT4240 Software Architecture\\\paragraph{}Smash Bros\\Implementation Document\\XNA Group 2}
...
\bibitem[VS10]{bib:visualstudio} Visual Studio | MSDN, \emph{Microsoft}, 2012,\\
		http://msdn.microsoft.com/en-us/vstudio/aa718325
		
\bibitem[XNA]{bib:xna} Download: Microsoft XNA Game Studio - MSDN, \emph{Microsoft}, 2012,\\
		http://www.microsoft.com/en-us/download/details.aspx?id=23714\#overview
		
\bibitem[FsPe]{bib:farseer} Download: Microsoft XNA Game Studio - MSDN, \emph{Microsoft}, 2012,\\
